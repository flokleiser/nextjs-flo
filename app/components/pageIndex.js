...
export default [
  ...
  { previewImage: '/images/pagePreviews/new/kontaktTest2.png', path: '/projects/animations/kontakt', title: 'Kontakt', content: 'Kontakt Animation', category: 'Animations', keywords: ['animation','kontakt', 'animated','after effects']},
  { previewImage: '/images/pagePreviews/new/logoTest2.png', path: '/projects/animations/logo', title: 'Logo', content: 'Logo Animation', category: 'Animations', keywords: ['animation','logo', 'animated','after effects']},
  { previewImage: '/images/pagePreviews/new/musicTest2.png', path: '/projects/animations/music', title: 'Music', content: 'Music Animations', category: 'Animations', keywords: ['animation','music', 'animated','after effects', 'public transport', 'blurry','piano']},
  ...
  { previewImage: '/images/pagePreviews/new/cadTest2.png', path: '/cad', title: 'CAD', content: 'CAD Butterfly Knife', category: 'Projects', keywords: ['cad','butterfly', 'knife','blender']},
  { previewImage: '/images/pagePreviews/new/craftsTest2.png', path: '/crafts', title: 'Crafts', content: 'Cardboard Crafts', category: 'Projects', keywords: ['crafts','spacecraft', 'cardboard','scrap']},
  { previewImage: '/images/pagePreviews/new/creativecodingTest2.png', path: '/creative-coding', title: 'Creative Coding', content: 'Creative Coding with p5js', category: 'Projects', keywords: ['creative coding','p5js', 'processing','javascript']},
  { previewImage: '/images/pagePreviews/new/illustratorTest2.png', path: '/illustrator', title: 'Illustrator', content: 'Illustrator Projects', category: 'Projects', keywords: ['illustrator','graphic design', 'comic','adobe']},
  { previewImage: '/images/pagePreviews/new/momentfulnessTest2.png', path: '/momentfulness', title: 'Momentfulness', content: 'Javascript Project', category: 'Projects', keywords: ['javascript','canvas', 'programming','visual']},
  { previewImage: '/images/pagePreviews/new/sketchesTest2.png', path: '/sketches', title: 'Sketches', content: 'Sketchbook', category: 'Projects', keywords: ['sketches','sketchbook','doodles']},
